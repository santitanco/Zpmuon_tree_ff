...
V_76 = Vertex(name = 'V_76',
              particles = [ P.P__tilde__CH, P.P__tilde__ch, P.Zpmu ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_9})

V_77 = Vertex(name = 'V_77',
              particles = [ P.vm__tilde__, P.vm, P.Zpmu ],
              color = [ '1' ],
              lorentz = [ L.FFV1, L.FFV2 ],
              couplings = {(0,1):C.GC_11,(0,0):C.GC_10})

V_78 = Vertex(name = 'V_78',
              particles = [ P.mu__plus__, P.mu__minus__, P.Zpmu ],
              color = [ '1' ],
              lorentz = [ L.FFV2 ],
              couplings = {(0,0):C.GC_12})

V_79 = Vertex(name = 'V_79',
              particles = [ P.Zpmu, P.Z, P.Z ],
              color = [ '1' ],
...
V_81 = Vertex(name = 'V_81',
              particles = [ P.Zpmu, P.W__plus__, P.W__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVV2, L.VVV3, L.VVV4, L.VVV5, L.VVV6, L.VVV7 ],
              couplings = {(0,0):C.GC_72, (0,1): C.GC_73, (0,2): C.GC_74, (0,3): C.GC_75, (0,4): C.GC_76, (0,5): C.GC_77})